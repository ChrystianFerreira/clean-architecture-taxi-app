...
export default class AccountDAODatabase implements AccountDAO, GetAccountAccountDAO, SignupAccountDAO {
  async save(account: any) {
    const connection = pgp()("postgres://postgres:123@localhost:5432/app");
     connection.query(`insert into cccat14.account (account_id, name, email, cpf, car_plate, is_passenger, is_driver) 
